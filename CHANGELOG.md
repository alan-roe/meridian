...
## [1.39.0](https://github.com/alan-roe/meridian/compare/meridian-v1.38.0...meridian-v1.39.0) (2026-04-24)
...
* add request debug logging for tool loop visibility ([0051d60](https://github.com/alan-roe/meridian/commit/0051d601d923cd0775fcde88d488d399ba915e63))
* add session resume support for conversation continuity ([c40ff63](https://github.com/alan-roe/meridian/commit/c40ff63149db52c68ebde816aaf13546cfd2d27f))
...
* clear error messages for auth failures and SDK crashes ([4e21e9a](https://github.com/alan-roe/meridian/commit/4e21e9a735a90620806253e6db410b36895708b4))
* concurrency control, auto-restart supervisor, error handling ([318ca75](https://github.com/alan-roe/meridian/commit/318ca751e3d1c6af1d7c29a86744da959b47e386))
...
* enable concurrent requests for subagent support (Phase 3) ([34452a3](https://github.com/alan-roe/meridian/commit/34452a332c91c047812b0073b576807d1c106dfd))
* error classification, health endpoint, and startup auth check ([43a80f1](https://github.com/alan-roe/meridian/commit/43a80f1754499830e1e85adbd82eb65bb0212b42))
...
* forward tool_use blocks to clients (Phase 1) ([6042cd7](https://github.com/alan-roe/meridian/commit/6042cd70f79bb1a7c66ca0f5e091ee19dd28a256))
* fuzzy match agent names for reliable subagent delegation ([fec9516](https://github.com/alan-roe/meridian/commit/fec9516b55341461c19129e94d3cc7d316876d71))
* fuzzy match agent names to fix invalid subagent_type values ([5364124](https://github.com/alan-roe/meridian/commit/53641241bee09f7aa11ba0da7c235cd68c54d190))
...
* passthrough mode for multi-model agent delegation ([4836a48](https://github.com/alan-roe/meridian/commit/4836a48889a110050e5ffdbc6fabf4a547e30c95))
* passthrough mode for multi-model agent delegation ([a74ced9](https://github.com/alan-roe/meridian/commit/a74ced9350be19a9916c13a944540135d9c4eabb)), closes [#21](https://github.com/alan-roe/meridian/issues/21)
...
* PreToolUse hook for reliable subagent delegation ([01df852](https://github.com/alan-roe/meridian/commit/01df852ef0d1ffd0bb888f2d6c0e392933c52b5e))
...
* register SDK agent definitions from OpenCode's Task tool ([afa480f](https://github.com/alan-roe/meridian/commit/afa480f2c0d39c1c88fec721137615f93e1a9d13))
* remove internal MCP tools, use maxTurns: 1 (Phase 2) ([a740574](https://github.com/alan-roe/meridian/commit/a740574e1a91bb78fab8f7c717b3c16285ab0fb4))
...
* session resume support for conversation continuity ([1e98be0](https://github.com/alan-roe/meridian/commit/1e98be0f8ffb9ff1c4d0d2c244c84a34b2504f32))
...
* transparent API proxy with full tool execution and subagent support ([96be81c](https://github.com/alan-roe/meridian/commit/96be81cb0f2e0420ad84b0b762bd0acf9832191e))
* true concurrent SDK sessions (no serialization) ([6dd5aa0](https://github.com/alan-roe/meridian/commit/6dd5aa02132bd94257a1b400bd78047bd5fc851b))
* use PreToolUse hook for agent name correction (replaces stream hacks) ([7cb37b6](https://github.com/alan-roe/meridian/commit/7cb37b66051b26058baf500da035ac600f51b8b9))
* validate passthrough architecture concept ([deed3db](https://github.com/alan-roe/meridian/commit/deed3dbf1b3bfc42f80a0983e6ea5094e09ae2d6))
...
* block SDK built-in tools, enforce MCP-only tool execution ([ca1f8e1](https://github.com/alan-roe/meridian/commit/ca1f8e163b6f00f047a709a2d9b4ea581be0d6a9))
...
* concurrent requests with auto-restart supervisor ([1a8f695](https://github.com/alan-roe/meridian/commit/1a8f6951437aeea6ea70c75c382c2d4c0bd582e5))
...
* deduplicate message_start/stop events in multi-turn streaming ([23a0044](https://github.com/alan-roe/meridian/commit/23a0044bc4d06be97b002e83438b951c04d2251b)), closes [#20](https://github.com/alan-roe/meridian/issues/20)
* deduplicate streaming events for cleaner multi-turn responses ([b98b2dd](https://github.com/alan-roe/meridian/commit/b98b2dd130acc464845f718177217ce66ce53a2f))
...
* deny Task tool retries via canUseTool callback ([8b1a8b0](https://github.com/alan-roe/meridian/commit/8b1a8b0b4fb229b5e7743f8a839eba5ab6111f3b))
...
* deterministically normalize agent names in task tool_use blocks ([64133e1](https://github.com/alan-roe/meridian/commit/64133e1928836faf3d5347188183e540209ae8ca))
...
* filter MCP tool events from stream, forward only client-facing tools ([18a0280](https://github.com/alan-roe/meridian/commit/18a02805680c29c96dd53788601577c78c709b33))
...
* increase session TTL to 24 hours, verified end-to-end ([181a5fe](https://github.com/alan-roe/meridian/commit/181a5fe741507291fcad3bbb64b97076f45f2ba9))
* inject agent type hints to prevent capitalization errors ([172dca1](https://github.com/alan-roe/meridian/commit/172dca1b7180c25a484b53ab2d1b766dc2113c2f))
...
* pass working directory to SDK for correct system prompt ([c0a3120](https://github.com/alan-roe/meridian/commit/c0a3120d3f5db54a429ca759017f5838ff94c33f))
* pass working directory to SDK query for correct system prompt ([d7bfc42](https://github.com/alan-roe/meridian/commit/d7bfc4267dcc70809ee341ed7fed576c21297c13)), closes [#18](https://github.com/alan-roe/meridian/issues/18)
...
* queue concurrent streaming requests to avoid ~60s delay ([fb30a48](https://github.com/alan-roe/meridian/commit/fb30a489abccb917a30c09d85c908f90a30143ee))
* queue concurrent streaming requests to avoid ~60s delay ([054dd2c](https://github.com/alan-roe/meridian/commit/054dd2cc6499b51c032ccbe7a08937dbe49e51ff))
...
* restore MCP tools with bypassPermissions for correct tool execution ([d25e45d](https://github.com/alan-roe/meridian/commit/d25e45d0ce05018840db76d13401eda9ef70cfa9))
...
* revert to Bun.serve, document known concurrent crash ([ecbaec2](https://github.com/alan-roe/meridian/commit/ecbaec2b779ea8a0fa6b92f9f684a638ef98b128))
...
* show friendly error message when port is already in use ([7b9d96a](https://github.com/alan-roe/meridian/commit/7b9d96a29cfc54ee7e9c288a4a0fa759bc51ed40)), closes [#16](https://github.com/alan-roe/meridian/issues/16)
